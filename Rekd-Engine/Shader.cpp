...
void Rekd2D::Core::Shader::Set(const std::string &location, int value)
{
...
void Rekd2D::Core::Shader::Set(const std::string &location, float value)
{
	std::map<std::string, unsigned int>::iterator it = m_Locations.find(location);
	int uniform;
	if (it == m_Locations.end())
...
void Rekd2D::Core::Shader::Set(const std::string &location, Vector2F value)
{
	std::map<std::string, unsigned int>::iterator it = m_Locations.find(location);
	int uniform;
	if (it == m_Locations.end())
...
void Rekd2D::Core::Shader::Set(const std::string &location, Vector3F value)
{
	std::map<std::string, unsigned int>::iterator it = m_Locations.find(location);
	int uniform;
	if (it == m_Locations.end())
...
void Rekd2D::Core::Shader::Set(const std::string &location, Vector4F value)
{
	std::map<std::string, unsigned int>::iterator it = m_Locations.find(location);
	int uniform;
	if (it == m_Locations.end())
...
void Rekd2D::Core::Shader::Set(const std::string &location, Matrix3x3F value)
{
	std::map<std::string, unsigned int>::iterator it = m_Locations.find(location);
	int uniform;
	if (it == m_Locations.end())
...
void Rekd2D::Core::Shader::Set(const std::string &location, Matrix4x4F value)
{
	std::map<std::string, unsigned int>::iterator it = m_Locations.find(location);
	int uniform;
	if (it == m_Locations.end())
...
Rekd2D::Core::Vector3F Rekd2D::Core::Shader::GetVec3(const std::string &location)
{
	std::map<std::string, unsigned int>::iterator it = m_Locations.find(location);
	int uniform;
	if (it == m_Locations.end())
...
Rekd2D::Core::Matrix3x3F Rekd2D::Core::Shader::GetMat3(const std::string &location)
{
	std::map<std::string, unsigned int>::iterator it = m_Locations.find(location);
	int uniform;
	if (it == m_Locations.end())
